...
function ranking() {
    ...
    puntosFinales.sort((a, b) => b.points - a.points); // Ordenamos de más a menos
...
function crearCarton() {
    const num = Math.floor(Math.random() * 99); // Número random del 1 al 99
    if (numerosCarton.length < 15) {
        // Hasta 15 números
...
function acertar() {
    for (let i = 0; i < cartonBingo; i++) {
        // Recorremos filas y columnas con la i y la j
...
function juego() {
    ...
    if (usuario === "" || usuario === null) {
        ...
        function jugarCarton() {
            ...
            if (
                window.confirm(
                    "Si quieres jugar con este cartón pulsa Aceptar, si deseas cambiarlo pulsa Cancelar"
                )
            ) {
            ...
            function conseguirBingo() {
                ...
                if (linea1 === true && linea2 === true && linea3 === true) {
                    ...
                    const volverJugar = window.confirm(
