...
const questiones = [ //Tenemos 27 letras en total

[{ letter: "a", answer: "abducir", status: 0, question: "CON LA A. Dicho de una supuesta criatura extraterrestre: Apoderarse de alguien"},
 { letter: "a", answer: "anticuario", status: 0, question: "CON LA A. Persona que colecciona antiguedades"},
...
[{ letter: "c", answer: "churumbel", status: 0, question: "CON LA C. Niño, crío, bebé"},
 { letter: "c", answer: "capo", status: 0, question: "CON LA C. Jefe de una mafia, especialmente de narcotraficantes"},
...
[{ letter: "g", answer: "galaxia", status: 0, question: "CON LA G. Conjunto enorme de estrellas, polvo interestelar, gases y partículas"},
 { letter: "g", answer: "gominola", status: 0, question: "CON LA G. Golosina blanda masticable, generalmente recubierta de azúcar"},
...
[{ letter: "h", answer: "harakiri", status: 0, question: "CON LA H. Suicidio ritual japonés por desentrañamiento"},
 { letter: "h", answer: "hinojo", status: 0, question: "CON LA H. Planta de flores amarillas que se usa como condimento, por el sabor de sus frutos parecido al del anís, y también en medicina"},
 { letter: "h", answer: "historia", status: 0, question: "CON LA H. Capacidad para inventar cosas o para pensar y hablar con gracia"}],
...
[{ letter: "k", answer: "kamikaze", status: 0, question: "CON LA K. Persona que se juega la vida realizando una acción temeraria"},
 { letter: "k", answer: "frank", status: 0, question: "CONTEIENE LA K. Apellido de una niña que ha pasado a la historia por su diario"},
...
[{ letter: "m", answer: "miriñaque", status: 0, question: "CON LA M. Prenda rígida o almidonada, a veces con aros, que antiguamente llevaban las mujeres bajo la falda para darle vuelo"},
 ...
 { letter: "m", answer: "madriguera", status: 0, question: "CON LA M. Cueva en que habitan ciertos animales, especialmente los conejos"}],

[{ letter: "n", answer: "necedad", status: 0, question: "CON LA N. Demostración de poca inteligencia"},
 { letter: "n", answer: "nabato", status: 0, question: "CON LA N. Espinazo de los vertebrados"},
...
[{ letter: "o", answer: "orco", status: 0, question: "CON LA O. Humanoide fantástico de apariencia terrible y bestial, piel de color verde creada por el escritor Tolkien"},
 ...
 { letter: "o", answer: "onirico", status: 0, question: "CON LA O. Perteneciente o relativo a los sueños"}],
...
[{ letter: "q", answer: "queso", status: 0, question: "CON LA Q. Producto obtenido por la maduración de la cuajada de la leche"},
 { letter: "q", answer: "equilatero", status: 0, question: "CON LA Q. Se dice del triángulo que tiene todos sus lados iguales"},
...
[{ letter: "s", answer: "stackoverflow", status: 0, question: "CON LA S. Comunidad salvadora de todo desarrollador informático"},
 { letter: "s", answer: "stotana", status: 0, question: "CON LA S. Traje negro y largo parecido a una túnica que llevan algunos curas y religiosos"},
 { letter: "s", answer: "sentar", status: 0, question: "CON LA S. Poner o colocar a alguien en una silla o banco"}],
...
[{ letter: "t", answer: "terminator", status: 0, question: "CON LA T. Película del director James Cameron que consolidó a Arnold Schwarzenegger como actor en 1984"},
 ...
 { letter: "t", answer: "testamento", status: 0, question: "CON LA T. Escrito o declaración de palabra en el que alguien dice lo que quiere que se haga después de su muerte"}],
...
[{ letter: "u", answer: "unamuno", status: 0, question: "CON LA U. Escritor y filósofo español de la generación del 98 autor del libro 'Niebla' en 1914"},
 ...
 { letter: "u", answer: "ultimo", status: 0, question: "Antónimo de Primero"}], 

[{ letter: "v", answer: "vikingos", status: 0, question: "CON LA V. Nombre dado a los miembros de los pueblos nórdicos originarios de Escandinavia, famosos por sus incursiones y pillajes en Europa"},
 { letter: "v", answer: "verbo", status: 0, question: "CON LA V. Palabra que indica acción o estado"},
...
[{ letter: "w", answer: "sandwich", status: 0, question: "CONTIENE LA W. Emparedado hecho con dos rebanadas de pan entre las cuales se coloca jamón y queso"},
 ...
 { letter: "w", answer: "whatsapp", status: 0, question: "CON LA W. Aplicaciín para enviar mensajes"}],


[{ letter: "x", answer: "estra", status: 0, question: "CONTIENE LA X. Prefijo que significa “fuera de”"},
 { letter: "x", answer: "botox", status: 0, question: "CONTIENE LA X. Toxina bacteriana utilizada en cirujía estética"},
 { letter: "x", answer: "auxiliar", status: 0, question: "CONTIENE LA X. El verbo haber es un verbo…"}],
...
{ letter: "z", answer: "zebra", status: 0, question: "CON LA Z. Animal blanco y negro"}], ]
...
function bienvenida(){ //Pedimos nombre de usuario
     let usuario= prompt('Porfavor introduce tu nombre de jugador');
        if(usuario===null||usuario===''){
            alert('Porfavor introduce un nombre válido');
            bienvenida();
        } else{
             window.alert(`Hola! Bienvenido/a ${usuario} a Pasapalabra! \nGanarás 1 punto por cada palabra acertada de cada definición. Para salir del juego en cualquier momento escribe "END". \n¿Estás preparado/a? `);
             juego();
        }
       
}   

function generarPreguntas(){ //Escogemos una pregunta al azar
    preguntaEscogida= [];
    for(let i=0; i<preguntaEscogida.length; i++){
        let preguntas= questiones[i][Math.floor(Math.random()*questiones[i].length)];
    }
}
  ...
  while(total<27){
    ...
    for(let i=0; i<preguntaEscogida.length;i++){
     if(preguntaEscogida[i].status===0){
       let respuesta= prompt(preguntaEscogida[i].preguntas +'Escribe tu respuesta sin acentos. \nRecuerda que escribiendo END finaliza el guejo y para pasar palabra escribe "pasapalabra" o pulsa Aceptar o Cancelar.' );
       if(respuesta===null){
           alert(`Respuesta incorrecta... La respuesta correcta es ${preguntaEscogida.answer}.`);
           preguntaEscogida[i].status=1
           total+=1;
           fallosTotales+=1;
       } 
       else if(respuesta.toLowerCase()==='pasapalabra'||respuesta.length===0){
           alert('Pasapalabra! \nMás adelante podrás volver a esta pregunta.');
       } 
       else if(respuesta.toLowerCase()===preguntaEscogida[i].answer){
...
function juego(){ //Aquí es donde tiene lugar el juego
  generarPreguntas();
  pasapalabra();
    if(total<27){
        alert(`En total has realizado ${total}preguntas y has acertado ${aciertosTotales} y fallado ${fallosTotales}.`);
        let puntuacion={
            jugador: "",
            puntos: 0
        }
...
function rankingOrdenado(){ //Ordenamos según el número de puntos
    rankingg.sort(function (a, b) {return b.answers - a.answers});
    for (i=0; i<rankingg.length; i++) {
